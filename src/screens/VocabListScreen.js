...
function VocabListScreen({ navigation, route }) {
  ...
  const getS3URL = (imageName) => {
    const s3Uri = `https://screencapdicscreenshots.s3-ap-southeast-1.amazonaws.com/${username}/${imageName}`;
    //e.g.,  `https://screencapdicscreenshots.s3-ap-southeast-1.amazonaws.com/cclee/__cropped__image-129.png`
    return s3Uri;
  };
